...
export default function PassengersManagement() {
  ...
  // Modal state
  const [viewPassenger, setViewPassenger] = useState<string | null>(null);
        ...
        <CardHeader>
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Select value={statusFilter} onValueChange={(v) => { setStatusFilter(v as PassengerStatus | 'all'); setCurrentPage(1); }}>
