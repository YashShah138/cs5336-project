...
import { StaffType, Staff } from '@/types';
...
export default function StaffManagement() {
  ...
  // Current tab
  const [currentTab, setCurrentTab] = useState<StaffType>('airline_staff');
  ...
  return (
    <div className="space-y-6">
      <Tabs value={currentTab} onValueChange={(v) => setCurrentTab(v as StaffType)}>
