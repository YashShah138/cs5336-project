      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="p-4 bg-primary/5 rounded-lg border border-primary/20">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4 text-center">
                    <div>
                      ...
                      <p className="font-semibold">{flight.airlineName || flight.airlineCode}</p>
                    </div>
                    <div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Briefcase className="h-5 w-5" />Bag Tracking ({passengerBags.length} bag{passengerBags.length !== 1 ? 's' : ''})
              </CardTitle>
            </CardHeader>
            <CardContent>
                            ...
                            return (
                              <React.Fragment key={step}>
                                <div className="flex flex-col items-center">
                                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${isComplete ? isCurrent ? 'bg-primary text-primary-foreground animate-pulse' : 'bg-success text-success-foreground' : 'bg-muted text-muted-foreground'}`}>
